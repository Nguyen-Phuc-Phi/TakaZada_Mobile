...
class ProblemScreen extends React.Component{
    ...
    constructor() {
        ...
        this.state = {
          ...
          entries_HS: [
            { link: require('../../Pictures/News/cai-thien-hieu-suat-may-tinh.jpg'),title:'NÂNG CẤP NÀO SẼ CẢI THIỆN HIỆU SUẤT MÁY TÍNH CỦA BẠN NHIỀU NHẤT ?',id:1},
            { link: require('../../Pictures/News/nguyen_nhan_may_tinh_cham.jpg'),title:'NẾU LAPTOP CỦA BẠN CHẠY QUÁ CHẬM THÌ ĐÂY LÀ CÁCH KHẮC PHỤC HIỆU QUẢ',id:6},
          ...
          activeSlide1:0,
          entries_MTBN: [
            { link:require('../../Pictures/News/781923.jpg'),title:'LÀM GÌ KHI MÁY TÍNH QUÁ NÓNG?',id:1},
            { link:require('../../Pictures/News/xu-ly-khi-laptop-bi-nong.jpg'),title:'LAPTOP BỊ NÓNG, NGUYÊN NHÂN VÀ CÁCH XỬ LÝ',id:2},
            { link:require('../../Pictures/News/Huong-khac-phuc-tinh-trang-laptop-bi-nong.jpg'),title:'LÀM THẾ NÀO ĐỂ KHẮC PHỤC TÌNH TRẠNG LAPTOP BỊ NÓNG',id:3},
            { link:require('../../Pictures/News/hinh1_01ee9.jpg'),title:'KINH NGHIỆM XỬ LÝ LAPTOP BỊ NÓNG',id:4},
            { link:require('../../Pictures/News/khac-phuc-may-tinh-nong.jpg'),title:'NGUYÊN NHÂN VÀ GIẢI PHÁP HẠ NHIỆT CHO PC? - PHẦN CUỐI',id:5},
            { link:require('../../Pictures/News/cach-xu-ly-khi-may-nong.jpg'),title:'LÀM GÌ KHI LAPTOP BỊ NÓNG RỰC, TỰ ĐỘNG TẮT MÁY',id:6},
          ],
          activeSlide2:0,
          entries_LKKHD: [
            { link:require('../../Pictures/News/linh_kien_ben_trong_may_tinh.png'),title:'LINH KIỆN BÊN TRONG MÁY TÍNH BÀN VÀ CÁC LỖI HAY GẶP - PHẦN 1',id:1},
            { link:require('../../Pictures/News/5-thanh-phan-de-hong-nhat-tren-PC.jpg'),title:'5 THÀNH PHẦN DỄ HỎNG NHẤT TRÊN PC',id:4},
            { link:require('../../Pictures/News/tong-hop-cac-loi-phan-cung-pc-thuong-gap.png'),title:'HƯỚNG DẪN PHÁN ĐOÁN BỆNH PHẦN CỨNG SỬA MAINBOARD - MÀN HÌNH -LAPTOP',id:3},
            { link:require('../../Pictures/News/3-nguyen-nhan-pho-bien-gay-hong-mainboard-PC.jpg'),title:'3 NGUYÊN NHÂN PHỔ BIẾN GÂY HỎNG MAINBOARD PC',id:4},
            { link:require('../../Pictures/News/7-tac-nhan-gay-hai-cho-phan-cung-may-tinh-co-the-ban-chua-biet.jpg'),title:'7 TÁC NHÂN GÂY HẠI CHO PHẦN CỨNG MÁY TÍNH CÓ THỂ BẠN CHƯA BIẾT',id:5},
            { link:require('../../Pictures/News/nhung-su-co-thuong-gap-tren-may-tinh-va-cach-khac-phuc.jpg'),title:'TỔNG HỢP CÁC LỖI PHẦN CỨNG PC THƯỜNG GẶP',id:6},
          ],
          activeSlide3:0,
          entries_VDK: [
            ...
            { link:require('../../Pictures/News/Cac-loi-thuong-gap-tren-may-tinh-va-cach-khac-phuc.jpg'),title:'KHẮC PHỤC MỘT SỐ LỖI MÁY TÍNH THƯỜNG GẶP - PHẦN 2',id:5},
            { link:require('../../Pictures/News/Cac-loi-thuong-gap-tren-may-tinh-va-cach-khac-phuc.jpg'),title:'KHẮC PHỤC MỘT SỐ LỖI MÁY TÍNH THƯỜNG GẶP - PHẦN 3',id:5},
        ...
        this._renderItem_HS = this._renderItem_HS.bind(this);
        this._renderItem_LKKHD = this._renderItem_LKKHD.bind(this);
        this._renderItem_MTBN = this._renderItem_MTBN.bind(this);
        this._renderItem_VDK = this._renderItem_VDK.bind(this);
            ...
            <TouchableOpacity onPress={()=>{
              ...
              <ImageBackground source={item.link} style={{width: 400, height: 300}}>
                <View style={{position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, justifyContent: 'flex-end', alignItems: 'flex-start'}}>
                  <Text style={{fontSize:14,paddingLeft:5,color:'white',fontWeight:'bold',backgroundColor:'#333333'}}>{item.title}</Text>
                </View>
              </ImageBackground>
            </TouchableOpacity>
          </View>
        ...
        return(
            <View style={styles.container}>
                  ...
                  <View style={styles._title}>
                    <Text style={{color:"#ffffff",fontSize:30}}>Hiệu suất</Text>
                  </View>
                  ...
                  <View style={styles._title}>
                    <Text style={{color:"#ffffff",fontSize:30}}>Máy tính bị nóng</Text>
                  </View>
                  <View style={{width:400,height:320,backgroundColor:'white',paddingTop:10}}>
                    <Carousel
                        ref={(c) => { this._carousel = c; }}
                  ...
                  <View style={styles._title}>
                    <Text style={{color:"#ffffff",fontSize:30}}>Linh kiện không hoạt động</Text>
                  </View>
                  <View style={{width:400,height:320,backgroundColor:'white',paddingTop:10}}>
                    <Carousel
                        ref={(c) => { this._carousel = c; }}
                  ...
                  <View style={styles._title}>
                    <Text style={{color:"#ffffff",fontSize:30}}>Vấn đề khác</Text>
                  </View>
                  <View style={{width:400,height:320,backgroundColor:'white',paddingTop:10}}>
                    <Carousel
                        ref={(c) => { this._carousel = c; }}
